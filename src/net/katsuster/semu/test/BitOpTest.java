...
public class BitOpTest {
    ...
    public void testGetField32() throws Exception {
        ...
        //0bit
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 0, 0));
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 32, 0));
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 1, 0));
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 33, 0));
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 31, 0));
        assertEquals(msg1, 0x0, BitOp.getField32(0xffffffff, 32, 0));

        //1bit
        assertEquals(msg1, 0x0, BitOp.getField32(0xfffffff0, 0, 1));
        assertEquals(msg1, 0x1, BitOp.getField32(0xffffffff, 32, 1));
        assertEquals(msg1, 0x0, BitOp.getField32(0xfffffff0, 1, 1));
        assertEquals(msg1, 0x1, BitOp.getField32(0xffffffff, 33, 1));
        assertEquals(msg1, 0x0, BitOp.getField32(0x7fffffff, 31, 1));
        assertEquals(msg1, 0x1, BitOp.getField32(0xffffffff, 32, 1));

        //5bits
        assertEquals(msg1, 0x10, BitOp.getField32(0x00002110, 0, 5));
        assertEquals(msg1, 0x00, BitOp.getField32(0x00004300, 0, 5));
        assertEquals(msg1, 0x13, BitOp.getField32(0x80de4d00, 10, 5));
        assertEquals(msg1, 0x02, BitOp.getField32(0x708b4300, 18, 5));
        assertEquals(msg1, 0x02, BitOp.getField32(0x708b4300, 82, 5));
        assertEquals(msg1, 0x11, BitOp.getField32(0x44be6500, 26, 5));
        assertEquals(msg1, 0x00, BitOp.getField32(0x07ad8700, 27, 5));
        assertEquals(msg1, 0x04, BitOp.getField32(0x87ad8700, 29, 5));

        //32bit
        assertEquals(msg1, 0xfffffff0, BitOp.getField32(0xfffffff0, 0, 32));
        assertEquals(msg1, 0xffffffff, BitOp.getField32(0xffffffff, 32, 32));
        assertEquals(msg1, 0x7ffffff8, BitOp.getField32(0xfffffff0, 1, 32));
        assertEquals(msg1, 0x7fffffff, BitOp.getField32(0xffffffff, 33, 32));
        assertEquals(msg1, 0x00000000, BitOp.getField32(0x7fffffff, 31, 32));
        assertEquals(msg1, 0x00000001, BitOp.getField32(0xffffffff, 31, 32));
    }
    ...
    public void testSetField32() throws Exception {
        ...
        //1bit
        assertEquals(msg1, 0x80000009, BitOp.setField32(0x80000008, 0, 1, 0x1));
        assertEquals(msg1, 0x90000008, BitOp.setField32(0x10000008, 31, 1, 0x1));
        assertEquals(msg1, 0x70008000, BitOp.setField32(0x70000000, 15, 1, 0x1));
        assertEquals(msg1, 0x70008000, BitOp.setField32(0x70000000, 47, 1, 0x1));
        ...
        assertEquals(msg1, 0x708b4300, BitOp.setField32(0x70cf4300, 82, 5, 0xe2));
