...
public class RAMTest {
    ...
    public void alignedAccess8(long start, SlaveCore64 obj) throws Exception {
        ...
        for (int i = 0; i < actual8.length; i++) {
            obj.write8(null, start + i, actual8[i]);
        }
        ...
        for (int i = 0; i < expected8_8.length; i++) {
            Assert.assertEquals(msg1, expected8_8[i], obj.read8(null, start + i) & 0xffL);
        }
        ...
        for (int i = 0; i < expected8_16.length; i++) {
            Assert.assertEquals(msg1, expected8_16[i], obj.read16(null, start + i * 2) & 0xffffL);
        }
        ...
        for (int i = 0; i < expected8_32.length; i++) {
            Assert.assertEquals(msg1, expected8_32[i], obj.read32(null, start + i * 4) & 0xffffffffL);
        }
        ...
        for (int i = 0; i < expected8_64.length; i++) {
            Assert.assertEquals(msg1, expected8_64[i], obj.read64(null, start + i * 8));
        }
    }
    ...
    public void alignedAccess16(long start, SlaveCore64 obj) throws Exception {
        ...
        for (int i = 0; i < actual16.length; i++) {
            obj.write16(null, start + i * 2, actual16[i]);
        }
        ...
        for (int i = 0; i < expected16_8.length; i++) {
            Assert.assertEquals(msg1, expected16_8[i], obj.read8(null, start + i) & 0xffL);
        }
        ...
        for (int i = 0; i < expected16_16.length; i++) {
            Assert.assertEquals(msg1, expected16_16[i], obj.read16(null, start + i * 2) & 0xffffL);
        }
        ...
        for (int i = 0; i < expected16_32.length; i++) {
            Assert.assertEquals(msg1, expected16_32[i], obj.read32(null, start + i * 4) & 0xffffffffL);
        }
        ...
        for (int i = 0; i < expected16_64.length; i++) {
            Assert.assertEquals(msg1, expected16_64[i], obj.read64(null, start + i * 8));
        }
    }
    ...
    public void alignedAccess32(long start, SlaveCore64 obj) throws Exception {
        ...
        for (int i = 0; i < actual32.length; i++) {
            obj.write32(null, start + i * 4, actual32[i]);
        }
        ...
        for (int i = 0; i < expected32_8.length; i++) {
            Assert.assertEquals(msg1, expected32_8[i], obj.read8(null, start + i) & 0xffL);
        }
        ...
        for (int i = 0; i < expected32_16.length; i++) {
            Assert.assertEquals(msg1, expected32_16[i], obj.read16(null, start + i * 2) & 0xffffL);
        }
        ...
        for (int i = 0; i < expected32_32.length; i++) {
            Assert.assertEquals(msg1, expected32_32[i], obj.read32(null, start + i * 4) & 0xffffffffL);
        }
        ...
        for (int i = 0; i < expected32_64.length; i++) {
            Assert.assertEquals(msg1, expected32_64[i], obj.read64(null, start + i * 8));
        }
    }
    ...
    public void alignedAccess64(long start, SlaveCore64 obj) throws Exception {
        ...
        for (int i = 0; i < actual64.length; i++) {
            obj.write64(null, start + i * 8, actual64[i]);
        }
        ...
        for (int i = 0; i < expected64_8.length; i++) {
            Assert.assertEquals(msg1, expected64_8[i], obj.read8(null, start + i) & 0xffL);
        }
        ...
        for (int i = 0; i < expected64_16.length; i++) {
            Assert.assertEquals(msg1, expected64_16[i], obj.read16(null, start + i * 2) & 0xffffL);
        }
        ...
        for (int i = 0; i < expected64_32.length; i++) {
            Assert.assertEquals(msg1, expected64_32[i], obj.read32(null, start + i * 4) & 0xffffffffL);
        }
        ...
        for (int i = 0; i < expected64_64.length; i++) {
            Assert.assertEquals(msg1, expected64_64[i], obj.read64(null, start + i * 8));
        }
    }
}